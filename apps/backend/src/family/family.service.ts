...
const QUEST_CATALOG = [
  ...
  },
  {
    ...
    description: 'Aprende a distinguir lo que necesitas de lo que quieres.',
    rewardXp: 90,
    rewardCents: 0,
    lessonKey: 'needs_wants',
  },
  {
    title: 'El fondo de emergencia',
    description: 'Descubre por qué el dinero "por si acaso" es imprescindible.',
    rewardXp: 100,
    rewardCents: 0,
    lessonKey: 'emergency',
  },
  {
    title: 'La inflación',
    description: 'Entiende por qué el dinero guardado pierde valor con el tiempo.',
    rewardXp: 110,
    rewardCents: 0,
    lessonKey: 'inflation',
  },
  {
    title: '¿Para qué sirve un banco?',
    description: 'Conoce cómo funcionan los bancos y las cuentas de ahorro.',
    rewardXp: 80,
    rewardCents: 0,
    lessonKey: 'banking',
  },
  {
    title: 'El crédito: herramienta o trampa',
    description: 'Aprende a usar el crédito sin caer en deudas.',
    rewardXp: 120,
    rewardCents: 0,
    lessonKey: 'credit',
  },
  {
    title: 'Impuestos: ¿qué son?',
    description: 'Entiende para qué sirven los impuestos y cómo te afectan.',
    rewardXp: 90,
    rewardCents: 0,
    lessonKey: 'taxes',
  },
  {
    title: 'Crea tu propio negocio',
    description: 'Descubre qué hace falta para ser emprendedor.',
    rewardXp: 110,
    rewardCents: 0,
    lessonKey: 'entrepreneur',
  },
  {
    title: 'Los trucos de la publicidad',
    description: 'Aprende a reconocer las técnicas que usan los anuncios.',
    rewardXp: 100,
    rewardCents: 0,
    lessonKey: 'advertising',
  },
  {
    title: 'El costo de elegir',
    description: 'Cada decisión tiene un costo de oportunidad — aprende a verlo.',
    rewardXp: 110,
    rewardCents: 0,
    lessonKey: 'opportunity_cost',
  },
  {
    title: 'Dar y compartir',
    description: 'Descubre por qué dar forma parte de una vida financiera sana.',
    rewardXp: 80,
    rewardCents: 0,
    lessonKey: 'giving',
  },
  {
    ...
    description: 'Aprende a encontrar el mejor precio para lo que quieres.',
    rewardXp: 90,
    rewardCents: 0,
    lessonKey: 'comparison',
  },
  {
    title: 'Dinero digital',
    description: 'Entiende cómo funcionan las tarjetas y los pagos digitales.',
    rewardXp: 100,
    rewardCents: 0,
    lessonKey: 'digital_money',
  },
  {
    title: 'Cuidado con los fraudes',
    description: 'Aprende a reconocer y evitar las estafas más comunes.',
    rewardXp: 110,
    rewardCents: 0,
    lessonKey: 'scams',
  },
  {
    title: 'Inversión: dinero que trabaja',
    description: 'Aprende los fundamentos de invertir y por qué empezar joven importa.',
    rewardXp: 130,
    rewardCents: 0,
    lessonKey: 'investing',
  },
  {
    ...
    description: 'Descubre cómo tus sentimientos afectan tus decisiones financieras.',
    rewardXp: 100,
    rewardCents: 0,
    lessonKey: 'money_emotions',
  },
  {
    title: 'Cómo ganar más dinero',
    description: 'Explora las distintas formas de generar ingresos.',
    rewardXp: 110,
    rewardCents: 0,
    lessonKey: 'income',
  },
  {
    ...
    description: 'Aprende a planear el futuro financiero paso a paso.',
    rewardXp: 120,
    rewardCents: 0,
    lessonKey: 'long_goals',
  },
  {
    title: 'El arte de negociar',
    description: 'Aprende técnicas para conseguir mejores precios y condiciones.',
    rewardXp: 110,
    rewardCents: 0,
    lessonKey: 'negotiation',
  },
  {
    title: '¿Para qué sirve el seguro?',
    description: 'Entiende cómo los seguros protegen tu dinero ante imprevistos.',
    rewardXp: 100,
    rewardCents: 0,
    lessonKey: 'insurance',
  },
  {
    title: 'El valor real de las cosas',
    description: 'Aprende a distinguir entre precio y valor para gastar mejor.',
    rewardXp: 120,
    rewardCents: 0,
    lessonKey: 'value',
  },
