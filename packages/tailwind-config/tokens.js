...
const themes = {
  zen: {
    canvas: '#FAFBF6', ink: '#1D3557', accent: '#E63946', accentInk: '#F1FAEE',
    soft: 'rgba(168,218,220,0.40)', darkBg: '#1D3557', darkInk: '#F1FAEE',
    cardBorder: '#1D3557', tabBg: '#F1FAEE',
  },
  temple: {
    canvas: '#13243B', ink: '#F1FAEE', accent: '#E63946', accentInk: '#F1FAEE',
    soft: 'rgba(69,123,157,0.30)', darkBg: '#E63946', darkInk: '#F1FAEE',
    cardBorder: 'rgba(168,218,220,0.22)', tabBg: '#0F1D30',
  },
  coral: {
    canvas: '#FFF3F1', ink: '#1D3557', accent: '#E63946', accentInk: '#FFF3F1',
    soft: 'rgba(230,57,70,0.10)', darkBg: '#1D3557', darkInk: '#F1FAEE',
    cardBorder: '#E63946', tabBg: '#FFFFFF',
  },
};
